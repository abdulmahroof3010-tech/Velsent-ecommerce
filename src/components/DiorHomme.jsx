...
function DiorHomme({id}) {
   const datas = useFetch('products')?.filter(p=>p.isActive);

const data = datas
  ?.filter((val) => val.type === "Dior Homme")
  ...
  return (
    ...
    <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
      ...
      <div className="grid grid-cols-1 gap-5  md:grid-cols-3 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
