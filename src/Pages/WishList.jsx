...
function Wishlist() {
  ...
  const handleMoveToCart = (product) => {
    addToCart({...product,price:product.sale_price || Math.round(
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-10">
          ...
          <div className="flex justify-between mt-4">
            <h1 className="text-4xl font-light">My Wishlist</h1>
            <button
          ...
          {wishList.map((item) => (
            ...
            >
              ...
              <div className="p-5">
                ...
                <p className="text-xl font-semibold">₹{item.sale_price}</p>
